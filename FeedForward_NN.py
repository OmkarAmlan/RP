...
# Ensure a directory exists for saving plots
    ...
    plt.rcParams["figure.dpi"] = 300  # Set DPI for the saved image
    ...
    # Save the figure with a unique name for each epoch
    output_path = os.path.join(output_dir, f"epoch_{t+1}.png")
...
if __name__ == "__main__":
    ...
    # Import data
    dataset_raw = pd.read_csv("Datasets/HNEI_Processed/Final Database.csv")
...
# Save model
torch.save(model.state_dict(), os.getcwd() + '/Datasets/FF_Net_1.pth')            